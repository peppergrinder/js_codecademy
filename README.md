...
- [Debugging in VSC](#debugging-in-vsc)
...
## [Debugging in VSC](https://youtu.be/z2EsUIJKk6o?si=kiKyveOqSrrs84m9)
...
The `break` statements can be especially helpful when we’re looping through large data structures! With breaks, we can add test conditions besides the stopping condition, and exit the loop when they’re met
